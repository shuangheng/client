...
public class BlogList extends BaseList {
	...
	private ArrayList<Blogg> blogList;
	...
	public BlogList (BaseUi ui,int resourceId, ArrayList<Blogg> blogList) {
		this.ui = ui;
	...
	public View getView(int p, View v, ViewGroup parent) {
		...
		// fill html data
		blogItem.title.setText(AppFilter.getHtml(blogList.get(p).getTitle()));
