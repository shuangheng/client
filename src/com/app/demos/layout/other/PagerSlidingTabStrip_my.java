...
public class PagerSlidingTabStrip_my extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip_my(Context context) {
		this(context, null);
	}

	public PagerSlidingTabStrip_my(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PagerSlidingTabStrip_my(Context context, AttributeSet attrs, int defStyle) {
