package com.app.demos.layout.swipeRefreshLayout;
 ...
 */
public class Progress_image extends ViewGroup {
    // Maps to ProgressBar.Large style
    public static final int LARGE = MaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MaterialProgressDrawable.DEFAULT;

    private static final String LOG_TAG = Progress_m.class.getSimpleName();
    ...
    private static final int DEFAULT_CIRCLE_TARGET = 164;//progress to top 高度
     ...
     * @param context
     */
    public Progress_image(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public Progress_image(Context context, AttributeSet attrs) {
        super(context, attrs);
