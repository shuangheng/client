 ...
 * </p>
 */
public class Progress_m extends ViewGroup {
     ...
     * @param context
     */
    public Progress_m(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public Progress_m(Context context, AttributeSet attrs) {
        super(context, attrs);
