package com.app.demos.layout.swipebacklayout;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context) {
        this(context, null);rootView=this;
    }
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mDragHelper = ViewDragHelper.create(this, 0.3f, new ViewDragCallback());
     ...
     * callback's
     * {@link com.app.demos.layout.swipebacklayout.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.app.demos.layout.swipebacklayout.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        @Override// tryCaptureView如何返回ture则表示可以捕获该view，你可以根据传入的第一个view参数决定哪些可以捕获
        public boolean tryCaptureView(View view, int i) {
            /*   //edge only can swipe back
            ...
            return ret;   //edge only can swipe back
            */
            //all view can swipe back
            mTrackingEdge = EDGE_LEFT;//swipe back 方向
            ViewGroup decor = (ViewGroup) mActivity.getWindow().getDecorView();
            ViewGroup decorChild = (ViewGroup) decor.getChildAt(0);
            return view == decorChild.getChildAt(0);//all view can swipe back
        }
         ...
         * left , top 分别为即将移动到的位置，比如横向的情况下，
         * 我希望只在ViewGroup的内部移动，即：最小>=paddingleft，最大<=ViewGroup.getWidth()-paddingright-child.getWidth
         **/
